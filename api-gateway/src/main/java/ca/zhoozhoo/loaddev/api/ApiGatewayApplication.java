...
/// routing them to appropriate microservices (loads, rifles, components, mcp-server).
///
/// **Auto-Configuration Exclusions:**
///
/// - `SimpleMetricsExportAutoConfiguration` - Excluded to prevent SimpleMeterRegistry
/// from being created. We use OpenTelemetry for metrics export instead.
///
/// **OpenTelemetry Integration:**
///
/// The gateway imports OpenTelemetry configurations for comprehensive observability:
///
/// - [ca.zhoozhoo.loaddev.common.opentelemetry.OpenTelemetryConfiguration] - Configures
/// OpenTelemetry SDK with OTLP exporters for metrics, traces, and logs
/// - [ca.zhoozhoo.loaddev.common.opentelemetry.ContextPropagationConfiguration] - Enables
/// automatic propagation of trace context (W3C Trace Context) across service boundaries
///
