...
///
/// Reactor context propagation is enabled via `spring.reactor.context-propagation=AUTO`
...
/// and generally doesn't add much value compared to HTTP server/client observations.
///
...
public class ObservationConfiguration {
    ...
    ///
    /// The Spring Security filter chain observation creates scopes that don't properly
    /// work with reactive context propagation, causing warnings about observation scope mismatches.
    /// Since this observation doesn't provide critical value and causes issues, we disable it.
    ///
