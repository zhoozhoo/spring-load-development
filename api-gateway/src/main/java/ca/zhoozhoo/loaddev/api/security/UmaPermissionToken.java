...
///
/// A permission token is an enhanced access token that includes resource-specific
/// permissions based on Keycloak's authorization policies. It is obtained through
/// the UMA grant type: `urn:ietf:params:oauth:grant-type:uma-ticket`.
///
/// This token can be forwarded to downstream microservices for fine-grained
/// authorization decisions without requiring additional Keycloak calls.
///
