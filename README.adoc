...
// Technology Stack
image:https://img.shields.io/badge/Java-26-blue?logo=openjdk["Java 26"]
image:https://img.shields.io/badge/Spring%20Boot-4.1.1-green?logo=springboot["Spring Boot 4.1.1"]
image:https://img.shields.io/badge/Spring%20Cloud-2025.1.3-green?logo=spring["Spring Cloud 2025.1.3"]
image:https://img.shields.io/badge/Spring%20AI-2.0.1-green?logo=spring["Spring AI 2.0.1"]
...
image:https://img.shields.io/badge/Helm-4-blue?logo=helm["Helm 4"]
image:https://img.shields.io/badge/Docker-Compose-blue?logo=docker["Docker Compose"]
image:https://img.shields.io/badge/OpenTelemetry-1.65.0-blue?logo=opentelemetry["OpenTelemetry 1.65.0"]
...
* *OpenTelemetry Instrumentation*: 2.31.1 (+ alpha)
* *Maven*: 4.0.0-rc-6 or later
* *PostgreSQL*: 18.6
* *Keycloak*: 26.7
* *Grafana*: 13.2.0
* *Loki*: 3.7.6
...
* Maven 4.0+ (4.0.0-rc-6 or later)
* Kubernetes cluster and kubectl (for Kubernetes deployment)
* Helm 4.0+ (for Helm deployment)
