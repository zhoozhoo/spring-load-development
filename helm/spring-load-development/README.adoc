...
* *Image*: `zhoozhoo.ca/spring-load-development/spring-loaddev-api-gateway:0.0.7`
* *Namespace*: `reloading`
...
* *Image*: `zhoozhoo.ca/spring-load-development/spring-loaddev-loads-service:0.0.7`
* *Namespace*: `reloading`
...
* *Image*: `zhoozhoo.ca/spring-load-development/spring-loaddev-components-service:0.0.7`
* *Namespace*: `reloading`
...
* *Image*: `zhoozhoo.ca/spring-load-development/spring-loaddev-rifles-service:0.0.7`
* *Namespace*: `reloading`
...
* *Image*: `zhoozhoo.ca/spring-load-development/spring-loaddev-mcp-server:0.0.7`
* *Namespace*: `reloading`
