...
└── charts/                      # Subcharts directory
    ...
    │       │   ├── Chart.yaml  # Version: 0.1.1-SNAPSHOT, AppVersion: 13.2.0
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 3.7.6
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 0.159.0
    ...
    │           ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 3.0.3
