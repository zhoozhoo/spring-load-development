...
└── charts/                      # Subcharts directory
    ...
    │       │   ├── Chart.yaml  # Version: 0.1.1-SNAPSHOT, AppVersion: 13.1.1
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 3.7.3
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 0.157.0
    ...
    │           ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 3.0.2
