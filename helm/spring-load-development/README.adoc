...
* *Image*: `zhoozhoo.ca/spring-load-development/api-gateway:0.1.0`
* *Namespace*: `reloading`
...
* *Image*: `zhoozhoo.ca/spring-load-development/loads-service:0.1.0`
* *Namespace*: `reloading`
...
* *Image*: `zhoozhoo.ca/spring-load-development/components-service:0.1.0`
* *Namespace*: `reloading`
...
* *Image*: `zhoozhoo.ca/spring-load-development/rifles-service:0.1.0`
* *Namespace*: `reloading`
...
* *Image*: `zhoozhoo.ca/spring-load-development/mcp-server:0.1.0`
* *Namespace*: `reloading`
