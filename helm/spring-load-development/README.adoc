...
* `discovery-server.yml` – infrastructure service settings
...
* *API Gateway* (`api-gateway`) - Main entry point and routing service
* *Loads Service* (`loads-service`) - Load data management service  
* *Components Service* (`components-service`) - Component management service
...
* *Image*: `zhoozhoo.ca/spring-load-development/api-gateway:0.1.1-SNAPSHOT`
* *Namespace*: `reloading`
...
* *Image*: `zhoozhoo.ca/spring-load-development/loads-service:0.1.1-SNAPSHOT`
* *Namespace*: `reloading`
...
* *Image*: `zhoozhoo.ca/spring-load-development/components-service:0.1.1-SNAPSHOT`
* *Namespace*: `reloading`
...
* *Image*: `zhoozhoo.ca/spring-load-development/rifles-service:0.1.1-SNAPSHOT`
* *Namespace*: `reloading`
...
* *Image*: `zhoozhoo.ca/spring-load-development/mcp-server:0.1.1-SNAPSHOT`
* *Namespace*: `reloading`
...
└── charts/                      # Subcharts directory
    ...
    │       │   ├── Chart.yaml  # Version: 0.1.1-SNAPSHOT, AppVersion: 12.3.3
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 3.6.5
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 0.145.0
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: v3.8.1
    ...
    │           ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 2.10.0
...
* `Chart.yaml` - Component metadata (version 0.1.1-SNAPSHOT with specific appVersion)
