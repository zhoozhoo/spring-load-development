...
└── charts/                      # Subcharts directory
    ...
    │       │   ├── Chart.yaml  # Version: 0.1.1-SNAPSHOT, AppVersion: 13.0.1
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 3.7.2
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 0.153.0
    ...
    │           ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 2.10.5
