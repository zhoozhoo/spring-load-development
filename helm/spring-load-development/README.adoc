...
└── charts/                      # Subcharts directory
    ...
    │       │   ├── Chart.yaml  # Version: 0.1.1-SNAPSHOT, AppVersion: 12.3.1
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 3.6.3
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 0.143.0
    ...
    │           ├── Chart.yaml   # Version: 0.1.1-SNAPSHOT, AppVersion: 2.9.0
