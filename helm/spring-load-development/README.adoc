...
└── charts/                      # Subcharts directory
    ...
    │       │   ├── Chart.yaml  # Version: 0.1.0-SNAPSHOT, AppVersion: 12.3.0
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.0-SNAPSHOT, AppVersion: 3.6.2
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.0-SNAPSHOT, AppVersion: 0.141.0
    ...
    │       │   ├── Chart.yaml   # Version: 0.1.0-SNAPSHOT, AppVersion: v3.8.0
