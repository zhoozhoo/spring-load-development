...
///
/// - getRifles - Retrieve all rifles
/// - getRifleById - Retrieve a specific rifle by ID
///
...
/// Test infrastructure:
///
/// - Uses [MockWebServer] from OkHttp to simulate rifles-service (port 8083)
...
public class RiflesToolProviderTest extends BaseMcpToolProviderTest {
    ...
    /// This validates that:
    ///
    /// - Inbound deserialization into [RifleDto] succeeds via QuantityModule.
    /// - MCP envelope serialization of the resulting `Mono<RifleDto>` does not fail when Quantity fields are non-null.
    /// - The JSON response surface includes the expected nested quantity structure.
    ///
