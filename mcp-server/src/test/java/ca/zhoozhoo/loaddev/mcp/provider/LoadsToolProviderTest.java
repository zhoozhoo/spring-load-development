...
///
/// - Server connectivity verification (ping)
/// - Tool discovery and listing
/// - getLoads - Retrieve all loads
/// - getLoad - Retrieve a specific load by ID
/// - getLoadDetails - Retrieve detailed information including rifle and statistics
///
...
/// Test infrastructure:
///
/// - Uses [MockWebServer] from OkHttp to simulate loads-service (port 8082)
/// and rifles-service (port 8083)
/// - Mocks [DiscoveryClient] to return service instances pointing to mock servers
/// - Provides mock JWT authentication via [TestSecurityConfig] to satisfy
/// security context requirements
/// - Uses [McpAsyncClient] with WebFlux SSE transport for async communication
///
...
public class LoadsToolProviderTest extends BaseMcpToolProviderTest {
    ...
    /// Uses [McpAsyncClient#ping()] which returns a [Mono] that is
    ...
    /// using [McpAsyncClient#listTools()]. The result is blocked to
    ...
    /// service calls:
    ///
    /// - Calls LoadsService.getLoadById() to get basic load information
    /// - Calls RiflesService.getRifleById() to get the associated rifle
    /// - Calls LoadsService.getGroupsByLoadId() to get statistics/groups
    ///
