...
///
/// Registers [QuantityModule] for serialization/deserialization of `Quantity` types.
/// Uses `@Lazy` injection to break circular dependency with Jackson customizer beans.
///
/// **Design Note:** JsonMapper is stored directly (not copied) to avoid triggering
