...
/// generic envelope serialization fails to properly handle `Quantity<?>` types,
...
public final class PreSerializationUtils {
    ...
    /// Serialize the given object using the provided [McpJsonMapper], logging success/failure with a
