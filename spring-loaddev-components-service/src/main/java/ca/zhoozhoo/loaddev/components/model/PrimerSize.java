 ...
 * both the case specifications and the powder charge requirements. Different primer sizes
 * provide varying ignition characteristics suitable for different cartridge types and powder loads.
 * </p>
 *
...
public enum PrimerSize {
    ...
    LARGE_RIFLE,
    /** Small magnum primer for rifle cartridges with heavy powder charges */
    SMALL_RIFLE_MAGNUM,
    /** Large magnum primer for rifle cartridges with heavy powder charges */
    LARGE_RIFLE_MAGNUM,
