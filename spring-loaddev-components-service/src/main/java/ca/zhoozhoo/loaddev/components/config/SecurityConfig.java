...
/**
 * Security configuration for the components service.
 * <p>
 * Configures WebFlux security with OAuth2 resource server support including
 * JWT authentication and custom authorities extraction from Keycloak realm
 * and resource roles. This configuration is active in all profiles except 'test'.
 * </p>
 *
