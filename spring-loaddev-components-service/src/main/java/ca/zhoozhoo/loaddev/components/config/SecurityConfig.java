...
/**
 * OAuth2 resource server security configuration with JWT and Keycloak authorities.
 * <p>
...
public class SecurityConfig {
    ...
    /**
     * Configures security filter chain with public actuator/docs endpoints.
     *
    ...
    /**
     * JWT authentication converter extracting Keycloak authorities.
     *
     * @return JWT to authentication converter
     */
    @Bean
    ...
    /**
     * Extracts Keycloak permissions as GrantedAuthority objects.
     * <p>
