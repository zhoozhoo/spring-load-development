...
/// Argument resolver for [CurrentUser] annotated method parameters.
///
/// Extracts the JWT subject claim from the security context and injects it into
/// controller method parameters annotated with `@CurrentUser`. Only supports
/// `String` type parameters. Uses Java 25 pattern matching for type-safe
/// principal handling.
///
/// Automatically registered when [SecurityAutoConfiguration] is active.
///
